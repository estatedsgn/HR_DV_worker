...
FAQ_MANAGER_FALLBACK = "Не хочу фантазировать без точных данных. Сформулируй, пожалуйста, вопрос чуть конкретнее."
...
- Если в FAQ нет ответа, не выдумывай. Попроси сформулировать вопрос конкретнее.
