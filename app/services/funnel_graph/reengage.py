...
# денежный крючок — главная зацепка («многие отказываются, пока не узнают сколько
# выходит»), но КОНКРЕТНЫЕ цифры намеренно не называем — политика «цифры на собесе».
COLD_TOUCH_TEXTS: tuple[tuple[str, ...], ...] = (
    (
        "слушай, понимаю, что сообщение от незнакомки выглядит подозрительно)) если коротко: это разговорные стримы, не вебкам и не оф, можно прямо с телефона, а по деньгам выходит очень приятно. если хоть чуть интересно — просто напиши «расскажи»",
        "не пугайся, я не спам-бот)) реально ищу девочек в команду на разговорные стримы. без вебкама и без вложений, а зарабатывать можно прилично) если интересно — напиши, всё расскажу голосом",
    ),
    (
        "честно скажу как есть: многие сначала пропускают, а как узнают, сколько тут реально выходит — возвращаются)) выплаты каждую неделю на карту, совмещать с учёбой или работой легко. хочешь, расскажу про доход и график?",
        "не хочу навязываться, но было бы обидно, если ты упустишь из-за сомнений) тут нормальные деньги за обычное общение в эфире, без вебкама и вложений. скажи, и я скину подробности про оплату 🐬",
    ),
    (
        "ладно, больше не дёргаю)) просто на случай, если передумаешь — у нас стабильный доход с еженедельными выплатами, и старт без вложений. захочешь узнать цифры — я на связи 🐬",
        "всё, не надоедаю) если станет любопытно, сколько можно поднимать на разговорных стримах — просто напиши, расскажу всё честно в любое время)",
    ),
)
